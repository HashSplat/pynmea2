...
def cnb_latlon_format(n):
    return str(n / 600000.0) # Divide by 10000 as well?
...
# type1 =() # Position Report Class A
# type2 =() # Position Report Class A (Assigned schedule)
# type3 =() # Position Report Class A (Response to Interrogation)

type4 = ( # Base Station Report
...
type5 = ( # Static and Voyage Related Data
...
type6 = ( # Binary Addressed Message
...
type8 = ( # Binary Broadcast Message
    spare(2),
    bitfield("application_id",  16, 'unsigned', 0,    "Application ID"),
...
type9 = ( # Standard SAR Aircraft Position Report
...
type10 = ( # UTC and Date Inquiry
    spare(2),
    bitfield("dest_mmsi",       30, 'unsigned', None, "Destination MMSI"), 
    spare(2),
   )

# type11 = () # UTC and Date Response

type12 = ( # Addressed Safety Related Message
    bitfield("seqno",            2, 'unsigned', None, "Sequence Number"),
    bitfield("dest_mmsi",       30, 'unsigned', None, "Destination MMSI"),
    bitfield("retransmit",       1, 'unsigned', None, "Retransmit flag"),
    spare(1),
...
# type13 = () # Safety Related Acknowledgement

type14 = ( # Safety Related Broadcast Message
    spare(1),
...
type16 = ( # Assignment Mode Command
    spare(2),
    bitfield("mmsi1",     30, 'unsigned', 0, "Interrogated MMSI"),
...
type17 = ( # DGNSS Binary Broadcast Message
    spare(2),
...
type18 = ( # Standard Class B CS Position Report
...
type19 = ( # Extended Class B Equipment Position Report
    bitfield("reserved",    8,  'unsigned', None,      "Regional reserved"),
    bitfield("speed",       10, 'unsigned', 1023,      "Speed Over Ground",
             formatter=cnb_speed_format),
    bitfield("accuracy",    1,  'unsigned', None,      "Position Accuracy"),
...
type21 = ( # Aid-to-Navigation Report
...
# type23 = () # Group Assignment Command
...
type24 = ( # Static Data Report
    bitfield('partno', 2, 'unsigned', None, "Part Number"),
    dispatch('partno', [type24a, type24b]),
    )

# type25 = () # Single Slot Binay Message
# type26 = () # Multiple Slot Binary Message With Communications State
# type27 = () # Position Report For Long-Range Applications
